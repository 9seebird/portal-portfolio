...
log = logging.getLogger("leave-anomaly.portal")

SERVICE_ID = "leave-anomaly"
SERVICE_NAME = "휴가 이상감지"
SERVICE_DESC = "연차 사용·발생 엑셀로 이상 사용 패턴·저사용·급증을 자동으로 찾아냅니다."
SERVICE_KEYWORDS = (
    "휴가 이상감지,연차 이상,연차 남용,휴가 패턴,고립 연차,금요일 연차,월요일 연차,"
    "연차 저사용,연차 쌓아두기,연차 미사용,연차 급증,연차 몰아쓰기,휴가 분석,연차 분석,휴가 모니터링"
)
